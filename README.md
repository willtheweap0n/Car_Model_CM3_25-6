...
To run code simply run the python script in the FDR Optimization file. During the process of running this code the file final_route_data.csv is created. This data is then used to create the route segments. As the code creates this file during its run there should be no need to download this file, as a precaution we have left the file in the github. If errors occur running the code this file can be downloaded seperately.
